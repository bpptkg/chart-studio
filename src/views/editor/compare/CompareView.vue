      ...
      <preview-pane :loading="isRendering">
        ...
        <v-snackbar v-model="snackbar" timeout="8000" left>
          <template v-slot:actions>
            ...
            <v-btn icon size="small" @click="snackbar = false" class="ml-2">
...
<script setup lang="ts">
  ...
  import { useCompareDataStore } from '@/stores/compareData'
  ...
  import { useCompareViewStore } from '@/stores/compareView'
